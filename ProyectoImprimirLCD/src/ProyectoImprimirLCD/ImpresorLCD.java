...
public class ImpresorLCD {
    ...
    private void imprimirMatriz(String[][] matriz){
        ...
        if( matriz != null){
            ...
            throw new NullPointerException("La matriz aun no ha sido inicializada");
        }
        
    }

    /**
     * Metodo que construye una matriz de strings para llenar luego con los simbolos que representaran digtos
     */
