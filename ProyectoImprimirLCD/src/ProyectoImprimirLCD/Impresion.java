...
public class Impresion {
    ...
    private int[] pf6Inicial;
    private int[] pf7Inicial;
    private int[] pf8Inicial;
    private int[] pf9Inicial;
    private int[] pf10Inicial;
    ...
    public void inicializarPuntosFijos(){
        ...
        pf6Inicial = new int[2];
        pf7Inicial = new int[2];
        pf8Inicial = new int[2];
        pf9Inicial = new int[2];
        pf10Inicial = new int[2];
        ...
        pf7Inicial[0] = (filasDigito / 2);
        pf7Inicial[1] = 0;

        pf8Inicial[0] = (filasDigito - 1);
        pf8Inicial[1] = 0;

        pf9Inicial[0] = (filasDigito / 2);
        pf9Inicial[1] = (columnasDigito - 1);

        pf10Inicial[0] = 0;
        pf10Inicial[1] = (columnasDigito - 1);
    }
